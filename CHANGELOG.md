...
#### :house: Internal
* `ember-cli-browserstack`
  * [#84](https://github.com/kategengler/ember-cli-browserstack/pull/84) Use prepack to add the README to the right place ([@kategengler](https://github.com/kategengler))
  * [#81](https://github.com/kategengler/ember-cli-browserstack/pull/81) Prepare Release v4.0.0 ([@github-actions[bot]](https://github.com/apps/github-actions))
* Other
