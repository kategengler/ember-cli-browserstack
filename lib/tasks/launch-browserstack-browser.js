...
let argv = require('yargs')
  ...
  .option('build', {
    describe: 'Build Name, defaults to process.env.TRAVIS_JOB_NUMBER or process.env.BITBUCKET_BUILD_NUMBER, if set',
    default: build
  }).help().argv;
...
if (process.env.TRAVIS_JOB_NUMBER) {
  ...
  settings.localIdentifier = process.env.BITBUCKET_BUILD_NUMBER;
}
