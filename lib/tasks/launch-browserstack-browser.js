...
let argv = require('yargs')
  ...
  .option('build', {
    describe: 'Build Name, defaults to process.env.TRAVIS_JOB_NUMBER or process.env.BITBUCKET_BUILD_NUMBER, if set, prefixed with process.env.BROWSERSTACK_BUILD_NAME_PREFIX, if set',
    default: build
  })
  .option('project', {
    alias: 'p',
